...
def upload():
    ...
    if uploaded_file.filename != '':
        ...
        for i,question in enumerate(generated_questions):
            ...
            # answer_text_elem.text = f"<![CDATA[<p>{answer_clean_up}</p>]]>"
...
def generate_questions(text):
    ...
    for choice in response.choices:
        ...
        # For simplicity, let's create options A, B, C, D as the answers
        # options = ["A", "B", "C", "D"]
        # correct_answer = options.pop()
